    ...
    findingTemplates: [
      {
        ...
        suggestedRewrite:
          "학과 팀 프로젝트에서 일정이 계속 밀리자, 저는 진행표를 다시 만들고 회의마다 남은 일을 확인해 발표 전날까지 최종 자료를 정리했습니다."
      },
      {
        id: "S-002",
        labels: ["안정성"],
        ...
        suggestedRewrite:
          "이 경험을 통해 문제를 작게 나누어 확인하는 습관을 얻었고, 지원 직무에서도 일정과 결과를 함께 관리하는 데 활용하고 싶습니다."
      }
    ]
  },
  report: {
    ...
    findingTemplates: [
      {
        ...
        suggestedRewrite:
          "2024년 한국교육개발원 조사에서는 20대 응답자의 디지털 학습 참여 경험이 전년보다 늘어난 것으로 나타났다."
      },
      {
        id: "S-102",
        labels: ["문체", "AI 리스크"],
    ...
    findingTemplates: [
      {
        ...
        suggestedRewrite:
          "동아리 홍보 페이지를 개편할 때 저는 신청 흐름을 정리했고, 안내 문구를 바꾼 뒤 문의가 줄어드는 것을 확인했습니다."
      }
    ]
  },
  reportCitationHeavy: {
    ...
    findingTemplates: [
      {
        ...
        suggestedRewrite:
          "2025년 대학생 학습 실태 조사에서는 응답자의 절반 이상이 온라인 자료를 병행한다고 답해, 온라인 학습 선호가 일부 집단에서 뚜렷하게 나타났다."
      }
    ]
  },
  shortText: {
    ...
    findingTemplates: [
      {
        ...
        suggestedRewrite:
          "이번 글에서는 제출 목적과 근거가 되는 사례를 먼저 밝히고, 마지막 문단에서 제가 확인한 결론을 분명히 정리하겠습니다."
      }
    ]
  },
  blogRepetition: {
    ...
    findingTemplates: [
      {
        ...
        suggestedRewrite:
          "운영팀은 5월 10일까지 고객 문의 유형과 처리 시간을 정리하고, 주간 회의에서 개선 우선순위를 공유하겠습니다."
      }
    ]
  },
  sensitiveInfo: {
    ...
    findingTemplates: [
      {
        ...
        suggestedRewrite:
          "제출 양식에서 요구한 연락처만 남기고, 주소와 식별 번호처럼 필요하지 않은 정보는 본문에서 제외했습니다."
      }
    ]
  },
  mixedDraft: {
