...
| `docs/26_SPRINT3_DESIGN_PACKAGE_RESPONSE_2026-05-02.md` | 제니 Sprint 3 조건부 승인 리뷰 응답 |
| `docs/27_ANALYSIS_V0_ACCEPTANCE_CRITERIA_2026-05-02.md` | 분석 v0 구현 전 수용 기준 |
| `docs/28_DATA_POLICY_COPY_SPEC_2026-05-02.md` | 사용자 화면 데이터 정책 카피 |
| `docs/29_EXTERNAL_DEMO_SCRIPT_2026-05-02.md` | 제한적 외부 데모 스크립트와 체크리스트 |

## 다음 단계 권장 순서

1. 제니가 `docs/27` 분석 v0 수용 기준 재검수
2. 제니가 `docs/28` 데이터 정책 카피 재검수
3. 제니가 `docs/29` 외부 데모 스크립트 재검수
4. 승인 후 rule-based analysis v0 구현 여부 결정
5. 외부 데모는 `docs/29` 승인과 배포 commit 일치 확인 후 진행
6. 실제 AI API 또는 사용자 원문 서버 저장은 별도 승인 전까지 보류
